...
namespace HalcyonJuegoSensorial.viewLayer.tercerDesafio.NivelesDesafio
{
	...
	public partial class ViewTercerNivel : ContentPage
	{
        ...
        private async void OnCorrectAnswerClicked(object sender, EventArgs e)
        {
            if (_usuario != null)
            {
                ...
                else
                {
                    ...
                    if (_usuario.Puntuacion > 900) _usuario.Puntuacion = 900; // Máximo de puntos para el nivel 3
        ...
        {
            var text = "En mí puedes ver tu cara sin moverte de tu lugar, ¿qué soy?";
