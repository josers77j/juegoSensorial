...
namespace HalcyonJuegoSensorial.viewLayer.tercerDesafio.NivelesDesafio
{
	...
	public partial class ViewPrimerNivel : ContentPage
	{
        ...
        private async void OnCorrectAnswerClicked(object sender, EventArgs e)
        {
            if (_usuario != null)
            {
                ...
                else
                {
                    ...
                    if (_usuario.Puntuacion > 700) _usuario.Puntuacion = 700; // Máximo de puntos para el nivel 3
        ...
        {
            var text = "Estoy en la casa y también en la escuela, tengo cuatro patas y un mantel de tela.";
