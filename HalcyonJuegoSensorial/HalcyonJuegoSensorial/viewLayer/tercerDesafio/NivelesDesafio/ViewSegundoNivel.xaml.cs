...
namespace HalcyonJuegoSensorial.viewLayer.tercerDesafio.NivelesDesafio
{
	...
	public partial class ViewSegundoNivel : ContentPage
	{
        ...
        private async void OnCorrectAnswerClicked(object sender, EventArgs e)
        {
            if (_usuario != null)
            {
                ...
                else
                {
                    ...
                    if (_usuario.Puntuacion > 800) _usuario.Puntuacion = 800; // Máximo de puntos para el nivel 3
        ...
        {
            var text = "Con teclas soy presionada, sin ellas no soy nada, ¿qué soy?";
